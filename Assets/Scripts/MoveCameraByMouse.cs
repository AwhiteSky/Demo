...
namespace HNLG
{
    ...
    public class MoveCameraByMouse : MonoBehaviour
    {
        ...
        //鼠标中键
        public bool UseWheelZoomEnabled=true;
        //鼠标右键
        ...
        public void MouseMove()
        {
            ...
            if (Mouse.current.middleButton.isPressed&&UseWheelZoomEnabled)
            {
                ...
                Vector3 Ntarget = target.transform.position + new Vector3(-mx * aimMoveSpeed * m_dis / 5000, 0, -my * aimMoveSpeed * m_dis / 5000);
                //限制摄像头移动
                //if (Ntarget.x > -10.6f && Ntarget.x < 10.6f && Ntarget.z > -18.4f && Ntarget.z < 18.4f)
                //{
                    ...
                    posy = v2.y;
                //}
                //if (target.transform.position.x > 10.6f)
                //{
                //    Vector3 aimpos = target.transform.position;
                //    aimpos.x = 10.6f;
                //    target.transform.position = aimpos;
                //}
                //if (target.transform.position.z < -18.4f)
                //{
                //    Vector3 aimpos = target.transform.position;
                //    aimpos.z = -18.4f;
                //    target.transform.position = aimpos;
        ...
        public void MouseRotate()
        {
            ...
            if (target)
            {
                ...
                if (Mouse.current.rightButton.isPressed&& UseRight)
                {
                ...
                m_rotation = Quaternion.LerpUnclamped (transform.rotation, rotation, Time.deltaTime * damping);
        ...
        public void SetCamera(Vector3 v3, float distance, float roatx, float roaty,float duration=0.5f)
        {
